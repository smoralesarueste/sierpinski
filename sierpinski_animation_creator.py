...
TOTAL_POINTS = FPS_RATE * TIME_LENGTH * POINTS_PER_FRAME
...
ln, = plt.plot([], [], 'bo', markersize = min(5, max(np.sqrt(1_000 / TOTAL_POINTS), 0.05)))
...
# Saving
filepath = str(Path(__file__).parent) + f"/sierpinski_vel{POINTS_PER_FRAME}.gif" 
